...
val1=nahar_${code}
val2=assafir_${code}
python visualize_neighbours.py --data_a $STD_DIR1/${code}.txt --data_b $STD_DIR2/${code}.txt --embed_a $EMB_DIR1/${code}.bin --embed_b $EMB_DIR2/${code}.bin --name_split_a ${val1} --name_split_b ${val2} --words "wikipedia/keywords/politicians.pkl" --out_topk $RES_DIR --k 300
