...
#SBATCH --gres=gpu:v100d32q:1#SBATCH --nodes=1
...
RES_DIR=results2/1968_1975/

val1=nahar_1968_1975
val2=hayat_1968_1975
python visualize_neighbours.py --data_a $STD_DIR1/1968_1975.txt --data_b $STD_DIR2/1968_1975.txt --embed_a $EMB_DIR1/1968_1975.bin --embed_b $EMB_DIR2/1968_1975.bin --name_split_a ${val1} --name_split_b ${val2} --words "words_1968_1975.txt" --out_topk $RES_DIR --k 300
