...
python evaluate_stability.py --models_path1 $EMB_DIR1 --models_path2=$EMB_DIR1 --keywords_path ${keywords_file} --mode d-assafir --k 100 --cvs_len 30
