...
def get_stability_linear_mapping(model1, model2, mat_name, words_path=None,
...
def get_stability_neighbors(model1, model2, words_path=None, k=50, t=5, save_dir='results/', file_name='stabilities_neighbors'):
    ...
    for _ in range(t):
        for w in vocab:
            ...
            stabilities[w] = st
            print('{}: sim_01: {}, sim_10: {}, st_nei: {}'.format(w, sim1, sim2, st))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path2', default='E:/fasttext_embeddings/ngrams4-size300-window5-mincount100-negative15-lr0.001/ngrams4-size300-window5-mincount100-negative15-lr0.001/', help='path to trained models files for second embedding')
    ...
    # parser.add_argument("--k", default=1000, help="number of nearest neighbors to consider per word - for neighbours and combined approach")
    ...
    # parser.add_argument("--num_steps", default=1000, help="number of training steps for gradient descent optimization")
    ...
    save_dir_combined_neighbor = os.path.join(save_dir, '{}_{}/t{}k{}/'.format(model1_name, model2_name, t, k)) # to save stability dictionaries of combined and neighbors approach
