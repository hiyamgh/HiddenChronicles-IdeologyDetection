...
if __name__ == '__main__':
    ...
    AN = Arabic_normalization()
    text = """
    نشرنا فى « نهار » ماض البيان الرسضى الذي
اذاعته المفوضة ااعليا وقالت فيه ان المفوض
الجديد يستقيل ابتداء من الساعةلرابعة واانصف
بعد ظهى الثثاء 7٠8 الحاري
وقبل ان ينشر هذا الببان اتصلت الحكومة
اللبثائية تليفونياً بإلوزراء السابقينوبعض الوجوء
ان المسو دي مارتل إستقيايم ف الموعد
المضروب , كا ابلغت ذلك الى سماحة رين
مجلس النواب الشيغ محمد الجسر في ممينه
بحر ساف .
"""

    AN.normalize_sentence(text)
