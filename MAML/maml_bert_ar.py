...
import itertools
from utils_nlp_ar import processors as processors
from utils_nlp_ar import output_modes as output_modes
from utils_nlp_ar import convert_examples_to_features
...
def main():
    ...
    parser.add_argument("--train_data", default="input/df_ar.xlsx", type=str, help="path to the .csv training dataset")
    parser.add_argument("--test_data",  default="input/sentences_ocr_corrected_discourse_profiling_ar.xlsx", type=str, help="path to the .csv testing  dataset")
