...
jar = "C:/Users/96171/Downloads/stanford-tagger-4.2.0/stanford-postagger.jar"
model = "C:/Users/96171/Downloads/stanford-tagger-4.2.0/models/arabic-train.tagger"
# model = "C:/Users/96171/Downloads/stanford-tagger-4.2.0/models/english-bidirectional-distsim.tagger"
...
def get_nouns(sents):
    nouns = []
    for s in sents:
        for tup in pos_tagger.tag(s.split(' ')):
            word_tag = tup[1]
            if 'NN' in word_tag or 'NNP' in word_tag or 'NNPS' in word_tag:
                nouns.append(word_tag.split('/')[0])
    return list(set(nouns))
...
def get_embeddings(model, tokenizer, text, is_semantic_entity=False, we=None, threshold = 0, device='cpu'):
