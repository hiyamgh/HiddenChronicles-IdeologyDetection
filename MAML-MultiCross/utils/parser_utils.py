...
id2dataset_multi = {
    ...
    "13": "input/split_general/sentences_train3.xlsx", # Arabic
    "14": "input/split_general/sentences_test3.xlsx", # Arabic
    "15": "input/split_general/sentences_train3.csv", # English
    "16": "input/split_general/sentences_test3.csv" # English
}
