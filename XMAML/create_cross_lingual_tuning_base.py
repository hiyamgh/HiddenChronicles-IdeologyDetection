                ...
                for inner_train_step in inner_train_steps_grid:
                    for inner_lr in inner_lr_grid:
                        for m_iter in meta_learn_iters:
                            ...
                            for model in models:
                                f.write(
                                    "--bert_model {} --model_type {} --dev_datasets_ids {} --dev_dataset_finetune {} --test_dataset_eval {} --do_validation 1 --do_finetuning 0 --do_evaluation 0 --meta_learn_iter {} --n {} --per_gpu_train_batch_size {} --inner_train_steps {} --inner_lr {} --labels {}  --output_dir_meta {}\n".format(
                                        ...
                                        ",".join(all_labels_VDC),
                                        "results_tuning_cross_lingual/VDC/{}-m_iter{}-inner_lr{}-inner_train_step{}-n{}-per_gpu_train_batch_size{}/".format(model, m_iter, inner_lr, inner_train_step, n, bs)
                                    ))
                            ...
                            for model in models:
                                f.write(
                                    "--bert_model {} --model_type {} --dev_datasets_ids {} --dev_dataset_finetune {} --test_dataset_eval {} --do_validation 1 --do_finetuning 0 --do_evaluation 0 --meta_learn_iter {} --n {} --per_gpu_train_batch_size {} --inner_train_steps {} --inner_lr {} --labels {} --output_dir_meta {}\n".format(
                                        ...
                                        m_iter, n, bs, inner_train_step, inner_lr,
                                        ",".join(all_labels_VDS),
                                        "results_tuning_cross_lingual/VDS/{}-m_iter{}-inner_lr{}-inner_train_step{}-n{}-per_gpu_train_batch_size{}/".format(model, m_iter, inner_lr, inner_train_step, n, bs)
                                    ))
                                model_i += 1
    f.close()
                            ...
                            for model in models:
                                f.write(
                                    "--bert_model {} --model_type {} --dev_datasets_ids {} --dev_dataset_finetune {} --test_dataset_eval {} --do_validation 1 --do_finetuning 0 --do_evaluation 0 --meta_learn_iter {} --n {} --per_gpu_train_batch_size {} --inner_train_steps {} --inner_lr {} --labels {} --output_dir_meta {}\n".format(
                                        ...
                                        m_iter, n, bs, inner_train_step, inner_lr,
                                        ",".join(all_labels_ARG),
                                        "results_tuning_cross_lingual/ARG/{}-m_iter{}-inner_lr{}-inner_train_step{}-n{}-per_gpu_train_batch_size{}/".format(model, m_iter, inner_lr, inner_train_step, n, bs)
                                    ))
                                model_i += 1
    f.close()
                            ...
                            for model in models:
                                f.write(
                                    "--bert_model {} --model_type {} --dev_datasets_ids {} --dev_dataset_finetune {} --test_dataset_eval {} --do_validation 1 --do_finetuning 0 --do_evaluation 0 --meta_learn_iter {} --n {} --per_gpu_train_batch_size {} --inner_train_steps {} --inner_lr {} --labels {} --output_dir_meta {}\n".format(
                                        ...
                                        m_iter, n, bs, inner_train_step, inner_lr,
                                        ";".join(all_labels_PTC),
                                        "results_tuning_cross_lingual/PTC/{}-m_iter{}-inner_lr{}-inner_train_step{}-n{}-per_gpu_train_batch_size{}/".format(model, m_iter, inner_lr, inner_train_step, n, bs)
                                    ))
                                model_i += 1
    f.close()