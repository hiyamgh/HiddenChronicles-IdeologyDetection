...
if __name__ == '__main__':
    ...
    with open(os.path.join(save_dir, 'VDS_cross_domain_large.txt'), 'w') as f:
        for n in support_sizes_grid:
            for bs in per_gpu_train_batch_sizes_grid:
                for inner_train_step in inner_train_steps_grid:
                    for inner_lr in inner_lr_grid:
    ...
    with open(os.path.join(save_dir, 'argumentation_cross_domain_large.txt'), 'w') as f:
        for n in support_sizes_grid:
            for bs in per_gpu_train_batch_sizes_grid:
                for inner_train_step in inner_train_steps_grid:
                    for inner_lr in inner_lr_grid:
    ...
    with open(os.path.join(save_dir, 'PTC_cross_domain_large.txt'), 'w') as f:
        for n in support_sizes_grid:
            for bs in per_gpu_train_batch_sizes_grid:
                for inner_train_step in inner_train_steps_grid:
                    for inner_lr in inner_lr_grid:
